...
def generate_assignments(data_generation, assignment_types, treatment_effects, network_configs, neighbour_influences, write_results=False):
    results = []
            ...
            for network_type, p_edges in network_configs:
                ...
                for influence in neighbour_influences:
                    ...
                    estimator = LinearRegressionEstimator(
                            individ_data,
                            self.data_generator.n_features,
                            self.data_generator.n_sim
                        )
