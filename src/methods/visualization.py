...
class ResultsPlotter:
    def __init__(self, estimated_effect, true_effect, network_type, assignment_type, neighbour_influence, treatment_mean):
    ...
    def create_results(self):
        ...
        table_name = f"markdown_results/{self.network_type}_{self.assignment_type}_{self.neighbour_influence}_{self.treatment_mean}.pkl"
...
#     logging.info(f"Pecrentage difference between true and estimated effect: {np.round(perc_diff, 3)}")

#     graph_name = f"{network_type}_{assignment_type}_{neighbour_influence}_{treatment_mean}.png"
#     plot_filename = f"visualization_results/{graph_name}"
